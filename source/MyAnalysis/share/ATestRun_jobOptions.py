...
if dataType == "mc":
    testFile = (
        os.getenv("ALRB_TutorialData")
        + "/mc20_13TeV.312276.aMcAtNloPy8EG_A14N30NLO_LQd_mu_ld_0p3_beta_0p5_2ndG_M1000.deriv.DAOD_PHYS.e7587_e7400_a907_r14861_r14919_p6026/DAOD_PHYS.37773721._000001.pool.root.1"
    )
else:
...
jps.AthenaCommonFlags.HistOutputs = ["ANALYSIS:TruthLevelAnalysis.outputs.root"]
